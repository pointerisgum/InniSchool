...
//            
//            UIEdgeInsets contentInset = self.sv_Main.contentInset;
//            contentInset.bottom = keyboardRect.size.height;
//            self.sv_Main.contentInset = contentInset;
        ...
        {
            //            CGRect frame = self.v_Comment.frame;
            //            frame.origin.y = self.view.frame.size.height - frame.size.height;
            //            self.v_Comment.frame = frame;
            //
            //            self.sv_Main.contentSize = CGSizeMake(self.sv_Main.contentSize.width, self.tbv_List.frame.origin.y + self.tbv_List.frame.size.height);
