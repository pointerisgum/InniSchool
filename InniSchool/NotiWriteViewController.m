...
@interface NotiWriteViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, IQActionSheetPickerViewDelegate>
...
@implementation NotiWriteViewController
...
- (void)doneButtonPress:(UIButton *)btn
{
    ...
    //http://127.0.0.1:7080/api/board/insertNotice.do?comBraRIdx=10001&userIdx=1004&title=문의사항 테스트&contents=문의사항 내용입니다.&cateCd=1&secretYn=Y
    ...
    [[WebAPI sharedData] imageUpload:@"board/insertNotice.do"
                               param:dicM_Params
