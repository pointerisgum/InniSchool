...
{
    [[UINavigationBar appearance] setBackgroundImage:BundleImage(@"btn_common_type10_p.png") forBarMetrics:UIBarMetricsDefault];
...
+ (NSString *)makeDate:(NSString *)aDate
{
    if( aDate.length == 8 )
    {
        NSString *str_Year = [aDate substringWithRange:NSMakeRange(0, 4)];
        NSString *str_Month = [aDate substringWithRange:NSMakeRange(4, 2)];
        NSString *str_Day = [aDate substringWithRange:NSMakeRange(6, 2)];
