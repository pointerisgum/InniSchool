...
@interface ClauseViewController () <UIWebViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.screenName = @"서비스 이용약관";
    
    [self initNavi];

    self.webView.delegate = self;
    
    NSString *str_Url = [NSString stringWithFormat:@"%@/front/webview/member/wvTermsPolicy.do", kBaseUrl];
